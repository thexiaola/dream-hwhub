...
:deep(.profile-card .el-card__header) {
  border-bottom: 1px solid rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.08) !important;
...
.profile-tabs :deep(.el-tabs__nav-wrap::after) {
  background-color: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.08) !important;
}

.profile-tabs :deep(.el-tabs__item) {
  color: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.55) !important;
  height: 40px;
  font-size: 14px;
  font-weight: 500;
}
...
:deep(.profile-form .el-form-item__label) {
  color: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.88) !important;
  font-weight: 500;
  font-size: 14px;
}
...
:deep(.profile-form .el-input__wrapper) {
  ...
  border: 1px solid rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.14);
...
:deep(.profile-form .el-input__wrapper:hover) {
  background: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.07) !important;
...
:deep(.profile-form .el-input.is-disabled .el-input__wrapper) {
  background: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.025) !important;
...
:deep(.profile-form .el-input__inner::placeholder) {
  color: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.32) !important;
}

:deep(.profile-form .el-input.is-disabled .el-input__inner) {
  color: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.55) !important;
  -webkit-text-fill-color: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.55) !important;
}

:deep(.profile-form .el-textarea__inner) {
  background: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.04) !important;
  border: 1px solid rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.14) !important;
  color: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.95) !important;
  border-radius: 8px !important;
  box-shadow: none !important;
}
...
:deep(.profile-form .el-count) {
  color: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.35) !important;
}
...
:deep(.profile-form .el-divider) {
  --el-border-color: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.08) !important;
  border-color: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.08) !important;
}
...
.summary-row {
  ...
  gap: 12px;
  padding: 9px 0;
  border-bottom: 1px solid rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.05);
  font-size: 13px;
}
...
.completion-list li .lucide {
  flex-shrink: 0;
  color: rgba(var(--r-fg), var(--g-fg), var(--b-fg), 0.3);
}
