 ...
 */
@Data
@JsonPropertyOrder({"id", "username", "email", "phone", "avatar", "isOp", "permissions", "verifyByPassword", "verifyByEmailCode", "disabledVerificationOperations", "isBanned", "registerTime", "lastLoginTime"})
